...
export default component$((props: IProps) => {
    ...
    const author = props.createdBy === 1 ? 'Manuel' : 'Finn'
    ...
    <>
        ...
        <div class="flex rounded-2xl gap-6 justify-between items-center w-full bg-primaryLight px-8 py-6">
            <div class="gap-2 flex flex-col ">
                ...
                <h3 title={props.title} class="font-bold text-text line-clamp-1 text-lg">
                    {props.title}
                </h3>
                ...
                {props.full_day
                    ? 'All day'
                    : props.time_start.toString() +
                    ' - ' +
                    props.time_end.toString()}
                </div>
            </div>
