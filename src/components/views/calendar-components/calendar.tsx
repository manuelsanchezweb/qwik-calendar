...
export const Calendar = component$(({ appointments, selectedDay } : { appointments: IAppointment[], selectedDay: Signal<Date>}) => {
        ...
        <div class="flex gap-8">
          <button onClick$={decrementMonth}>
            <svg width="20" height="34" viewBox="0 0 20 34" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M18.45 32.6335L2.83154 17.015L18.45 1.39655" stroke="#2B7277" stroke-width="3.38278"/>
            </svg>
          </button>
          <h2 class="text-text text-4xl font-semibold ">{getMonthName(date.value.getMonth(), date.value.getFullYear())}</h2>
        </div>
